...
public abstract class BackgrounderExtension {
     ...
     * `<bundle id>.backgrounder-tick`, to the array — the id `BackgroundTaskManager.shared`
     * uses on iOS when the app never calls `BackgroundTaskManager.create(tickIdentifier:)`.
